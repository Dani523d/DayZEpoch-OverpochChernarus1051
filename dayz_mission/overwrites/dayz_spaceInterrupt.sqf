...
//### BEGIN MODIFIED CODE: spawnplus commandmenu usage
...
if (_dikCode in[0x58,0x57,0x44,0x43,0x42,0x41,0x40,0x3F,0x3E,0x3D,0x3C,0x3B]) then {
//### END MODIFIED CODE:  spawnplus commandmenu usage
	_handled = true;
};
